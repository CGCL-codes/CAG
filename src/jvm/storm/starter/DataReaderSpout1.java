...
/*     */ 
/*     */ public class DataReaderSpout1 extends BaseRichSpout
/*     */ {
...
/*     */   String file_name="";
            ...
            /*** variable ds and ds_file
                * twitter : "resources/tweets_1m.csv","tw"
                * didi dataset:"resources/didi","didi"
                * stock dataset = "resources/STOCKtrace3.txt","stock"
                * Hash Tag dataset = "resources/hashtag.txt" , "hash"
            */
...
/*     */   {
            ...
            //"/home/mudassar/tweets_1m.csv"
            this.reader = new FileReaderChild("/home/mudassar/"+this.file_name,this.ds);
...
/*     */   }
/*     */ 
/*     */   DataReaderSpout1(String arg0, int spout, int bolt1, int bolt2, int is_aggregation, int number_tuples,int ackers,int sleep_time,String file_name,String ds) {
/*  97 */     this.number_of_tuples = number_tuples;
/*  98 */     this.arg0 = arg0;
...
/*     */ 
            public void nextTuple()
            {
                ...
                while (temp < this.number_of_tuples.intValue()) {
                    String key = null;
                    key = reader.getKey();
                    if(key != ""){
                        UUID msgId = UUID.randomUUID();
                        temp = Integer.valueOf(temp.intValue() + 1);
                        this.collector.emit(new Values(new Object[] { key}), msgId);
...
//                    for (String tw : temp_data) {
//                            if(tw != ""){
//                                UUID msgId = UUID.randomUUID();
//                                temp = Integer.valueOf(temp.intValue() + 1);
//                                //this.collector.emit(new Values(new Object[] { tw, Long.valueOf(1L) }), msgId);
//                                this.collector.emit(new Values(new Object[] { tw}), msgId);
//                                tuple_emit = tuple_emit + 1;
//                                Long t1 = Long.valueOf(System.nanoTime());
//                                this.pending.put(msgId, t1);
//                                if (temp.intValue() > this.number_of_tuples.intValue())
...
/* 224 */     DataReaderSpout1 localDataReaderSpout1 = this; Integer localInteger1 = localDataReaderSpout1.tuple_failed; Integer localInteger2 = localDataReaderSpout1.tuple_failed = Integer.valueOf(localDataReaderSpout1.tuple_failed.intValue() + 1);
/*     */     try
/*     */     {
